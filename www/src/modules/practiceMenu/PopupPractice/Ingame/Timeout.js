import PopupDialogItem from "../../../../view/popup/item/PopupDialogItem.js";
...
export default class Timeout extends BaseGroup {
    constructor(score) {
        super(game)
    ...
    addGemDetail() {
        ...
        gem.x = ((this.tabGem.width - sumWidth) / 2) + txtGem.width + 5 * window.GameConfig.RESIZE;
    ...
    addAnimTimeOut() {
        this.animTimeout = new Phaser.Sprite(game, 285 * window.GameConfig.RESIZE, 73 * window.GameConfig.RESIZE, 'timeout_practice');
        this.animTimeout.anchor.set(0.5, 0);
        let runTimeoutAnim = this.animTimeout.animations.add('run_load_timeout');
        this.animTimeout.animations.play('run_load_timeout', 24, true);
        this.popup.addChild(this.animTimeout);
    }
