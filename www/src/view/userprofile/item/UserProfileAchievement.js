...
export default class UserProfileAchievement extends BaseView {
    constructor() {
        super(game, null);
        this.event = {
        ...
        this.txtPlayList = new TextBase(this.positionUserProfile.playlist_txt_playlist, Language.instance().getData("162") + " (0)");
    ...
    setData(achievements) {
        ...
        */
        this.txtPlayList.text = Language.instance().getData("162") + " (" + achievements + ")";
    }
